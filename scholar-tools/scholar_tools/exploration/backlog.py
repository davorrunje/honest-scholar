"""Exploration backlog helper (scholar#5)."""
...
def add(item: str) -> dict[str, Any]:
    ...
    :raises NotImplementedError: Always — pending implementation (scholar#5).
    """
    raise NotImplementedError("exploration backlog helper — see scholar#5")
